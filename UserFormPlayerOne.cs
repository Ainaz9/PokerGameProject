...
{
    public partial class UserFormPlayerOne : Form
    {
        ...
        public UserFormPlayerOne(Guid currentUserId, IGameSessionService gameSessionService, IDbContextFactory<MyDbContext> contextFactory)
        {
            InitializeComponent();
        ...
        private void UpdateUI(GameSession session)
        {
            ...
            {
                var winnerUser = (session.WinnerId == _currentUserId) ? session.Player1 : session.Player2;
